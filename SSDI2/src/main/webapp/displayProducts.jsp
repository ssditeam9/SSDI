    ...
    <div class="top"><img alt="" style="width:200px" height="200px" src='<c:out value="${prod.imageurl}" />'></div>
      ...
      <div class="right">
        <div class="done"><i class="material-icons"></i></div>
		        <div class="details">
				       <label>Quote Price:<input type="text" id="divIDNo${x.index}"></label>
				       <button type="button" ng-click="quote(${x.index},${prod.minPrice},${prod.id})" style="width: 100px">Quote</button>
        		</div>
      </div>
  </div>
  </div></div>
