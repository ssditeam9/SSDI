...
<body ng-app="app">
		...
		<div class="signup">
			<form:form name="frm3" method="POST" action="/pay/save" modelAttribute="payment" ng-submit="update(email)">
				...
				<div class="card-type clearfix">
					...
					<form:input type="number" path="number"  placeholder="Card Number* 16 digits" ng-model="payment.number"  required="true" min="0" max="9999999999999999" 
   onKeyUp="if(this.value>9999999999999999){this.value='';}else if(this.value<0){this.value='0';}"/>
    				...
    				<form:input type="number" path="date"  placeholder="Expiry (mmyy)" ng-model="payment.date" required="true" min="0" max="9999" 
   onKeyUp="if(this.value>9999){this.value='';}else if(this.value<0){this.value='0';}"/>
